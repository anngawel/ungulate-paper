...
###### Just pigs ##############
mpigtot<-lm(totalsdl~log(pig), vegandsign)
mpigtot2<-lm(totalsdl~log(pig), vegandsign2)
summary(mpigtot)
summary(mpigtot2)

mpignat<-lm(nativsdl~log(pig), vegandsign)
mpignat2<-lm(nativsdl~log(pig), vegandsign2)
summary(mpignat)
summary(mpignat2)

mpignnat<-lm(nonnativesdl~log(pig), vegandsign)
mpignnat2<-lm(nonnativesdl~log(pig), vegandsign2)
summary(mpignnat)
summary(mpignnat2)

mpigvin<-lm(vines~log(pig), vegandsign)
mpigvin2<-lm(vines~log(pig), vegandsign2)
summary(mpigvin)
summary(mpigvin2) # p = 0.07 or 0.167 for log
...
###### Just deer ##############
mdeertot<-lm(totalsdl~log(deer), vegandsign)
mdeertot2<-lm(totalsdl~log(deer), vegandsign3)
summary(mdeertot)
summary(mdeertot2)

mdeernat<-lm(nativsdl~log(deer), vegandsign)
mdeernat2<-lm(nativsdl~log(deer), vegandsign2)
summary(mdeernat)
summary(mdeernat2)

mdeernnat<-lm(nonnativesdl~log(deer), vegandsign)
mdeernnat2<-lm(nonnativesdl~log(deer), vegandsign2)
summary(mdeernnat)
summary(mdeernnat2)

mdeervin<-lm(vines~log(deer), vegandsign)
mdeervin2<-lm(vines~log(deer), vegandsign2)
summary(mdeervin)
summary(mdeervin2)
